#code #example #obsidian #dataview
...
```#dataview
TABLE file.day AS "Date", summary
FROM "Daily Notes"
WHERE contains(file.outlinks, "Project A") OR contains(file.outlinks, "Project B")
FLATTEN file.lists AS summary
SORT file.day ASC
```